...
* Максимум 135 точки  <!-- .element: class="fragment" -->
  * 3 домашни за общо 45 точки<!-- .element: class="fragment" -->
  * Семестриален проект за 30 точки (Ние ще ви дадем задание за проекта) <!-- .element: class="fragment" -->
  * Kурсов проект от 40 до 80 точки (Определени от нас спрямо сложносттан. Най-често 60 точки) <!-- .element: class="fragment" -->

#HSLIDE
## Оценяване
* Допълнителни точки <!-- .element: class="fragment" -->
  * Бонус точки, ако добавите нещо, към някой проект с отворен код свързан с Elixir. <!-- .element: class="fragment" -->
  * Бонус точки за неща, които ние преценим. <!-- .element: class="fragment" -->
